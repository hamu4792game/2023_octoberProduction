...
public:
	...
	enum ScoreType {
		...
		Easy_02, //二分音符2つ : 1000 0000 1000 0000
		Easy_03, //四分音符3つ : 1000 1000 1000 0000
		Easy_04, //四分音符4つ : 1000 1000 1000 1000
		Easy_05, //二分1つ、四分2つ : 1000 0000 1000 1000
		Easy_06, //二分1つ、四分2つ : 1000 1000 0000 1000
		Easy_07, //四分音符3つ : 0000 1000 1000 1000
		Easy_08, //八分2つ、四分2つ : 1010 1000 0000 1000
		Easy_09, //八分2つ、四分2つ : 1010 1000 1000 0000
		Easy_10, //四分1つ、八分3つ : 1000 0000 1010 1000
		Normal_01, //四分3つ、八分2つ : 1000 1010 1000 1000
		Normal_02, //四分2つ、八分4つ : 1000 1010 1010 1000
		Normal_03, //四分2つ、八分4つ : 1010 1000 1010 1000
		Normal_04, //八分4つ : 1010 0000 1010 0000
		Normal_05, //四分2つ、八分4つ : 1000 1010 1000 1010
		Normal_06, //八分6つ : 1010 0010 1000 1010
		Normal_07, //四分4つ、八分1つ : 1010 0010 0010 0010
		Normal_08, //四分1つ、八分5つ : 1010 0010 1010 0010
		Normal_09, //四分1つ、八分6つ : 1010 1010 1010 1000
		Normal_10, //八分7つ : 1010 1010 0010 1010
